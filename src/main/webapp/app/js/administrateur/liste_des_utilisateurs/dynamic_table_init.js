function fnFormatDetails ( oTable, nTr )
{
    ...
    if(aData[5]=="Collaborateur")
         sOut += '<div class="btn-group"> <a  href="bilans_performances.html"><i class="fa fa-calendar-o btn btn-default"> Les bilans de performances</i></a></div>';
    sOut += '</table>';
